...
static HSHM_GPU_FUN chi::gpu::TaskContextBlock AllocTaskImpl(
  ...
  switch (method) {
    case Method::kAllocateBlocks: {
      auto fp = ipc->template NewTaskExec<AllocateBlocksTask>(stack_size);
      if (fp.IsNull()) return {hipc::FullPtr<chi::Task>::GetNull(), nullptr};
      auto *rctx = reinterpret_cast<chi::gpu::RunContext *>(
          reinterpret_cast<char *>(fp.ptr_) + sizeof(AllocateBlocksTask));
    ...
    case Method::kFreeBlocks: {
      auto fp = ipc->template NewTaskExec<FreeBlocksTask>(stack_size);
      if (fp.IsNull()) return {hipc::FullPtr<chi::Task>::GetNull(), nullptr};
      auto *rctx = reinterpret_cast<chi::gpu::RunContext *>(
          reinterpret_cast<char *>(fp.ptr_) + sizeof(FreeBlocksTask));
      new (rctx) chi::gpu::RunContext();
      rctx->InitStack(reinterpret_cast<char *>(rctx) + sizeof(chi::gpu::RunContext), stack_size);
      return {fp.template Cast<chi::Task>(), rctx};
    }
    case Method::kWrite: {
      auto fp = ipc->template NewTaskExec<WriteTask>(stack_size);
      if (fp.IsNull()) return {hipc::FullPtr<chi::Task>::GetNull(), nullptr};
      auto *rctx = reinterpret_cast<chi::gpu::RunContext *>(
          reinterpret_cast<char *>(fp.ptr_) + sizeof(WriteTask));
      new (rctx) chi::gpu::RunContext();
      rctx->InitStack(reinterpret_cast<char *>(rctx) + sizeof(chi::gpu::RunContext), stack_size);
      return {fp.template Cast<chi::Task>(), rctx};
    }
    case Method::kRead: {
      auto fp = ipc->template NewTaskExec<ReadTask>(stack_size);
      if (fp.IsNull()) return {hipc::FullPtr<chi::Task>::GetNull(), nullptr};
      auto *rctx = reinterpret_cast<chi::gpu::RunContext *>(
          reinterpret_cast<char *>(fp.ptr_) + sizeof(ReadTask));
      new (rctx) chi::gpu::RunContext();
      rctx->InitStack(reinterpret_cast<char *>(rctx) + sizeof(chi::gpu::RunContext), stack_size);
      return {fp.template Cast<chi::Task>(), rctx};
    }
    case Method::kUpdate: {
      auto fp = ipc->template NewTaskExec<UpdateTask>(stack_size);
      if (fp.IsNull()) return {hipc::FullPtr<chi::Task>::GetNull(), nullptr};
      auto *rctx = reinterpret_cast<chi::gpu::RunContext *>(
          reinterpret_cast<char *>(fp.ptr_) + sizeof(UpdateTask));
      new (rctx) chi::gpu::RunContext();
      rctx->InitStack(reinterpret_cast<char *>(rctx) + sizeof(chi::gpu::RunContext), stack_size);
      return {fp.template Cast<chi::Task>(), rctx};
    }
